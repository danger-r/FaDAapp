...
introduction <- function(){
  Textintro <- function(){
    ...
    "To allow a flexible use of the application with a minimum preparation time, samples identification can be in columns or rows. FaDA input requires:",
        ...
        tags$li("Second row or column must be labeled as 'Group' ", style="list-style-type: square;"),
        tags$li("Points should be used as decimal separators", style="list-style-type: square;"),
