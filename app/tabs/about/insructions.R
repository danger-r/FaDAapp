...
introduction <- function(){
  Textintro <- function(){
    ...
    "To allow a flexible use of the application with a minimum preparation time, samples identification can be in columns or rows. FaDA input requires:",
        ...
        tags$li("Second row or column must be labeled as ", tags$b(a("Group")), style="list-style-type: square;"),
    ...
    "FaDA provides comprehensive statistical analysis options on the sidebar, and an option to transform data to log2 or log10 values. Statistical analysis output can be downloaded in CSV or Excel files.",
...
While the Bonferroni method is useful with a fairly small number of comparisons, it may be too conservative and may lead to a high rate of false negatives. Both methods assume that the individual tests are independents (not correlated).", style="list-style-type: square;"),
  ...
  tags$h4("Copyright 2021 Center of Research in Transplantation and Immunology
Version 2021.07.12", align="center"),
